  ...
  return (
    <div className="bg-white shadow-lg rounded-lg p-8 pb-12 mb-8">
      ...
      <div className="grid gird-cols-1 gap-4 mb-4">
        <div>
          <input ref={storeDataEl} type="checkbox" id="storeData" name="StoreData" value="true" className="mr-2"/>
          <label className="text-gray-500 cursor-pointer" htmlFor="storeData">Save my E-Mail and Name for next time.</label>
        </div>
      </div>
